...
ALTER TABLE "linkedin_oauth_states" ADD CONSTRAINT "linkedin_oauth_states_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "linkedin_oauth_states_expires_at_idx" ON "linkedin_oauth_states" USING btree ("expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX "master_items_kind_name_unique" ON "master_items" USING btree ("kind",lower("name"));--> statement-breakpoint
