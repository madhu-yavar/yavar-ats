...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    ...
    <Preview>
      Confirm {recipient} to finish setting up your {siteName} account
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Confirming this address proves the mailbox belongs to you. It is required before your
          organisation can be submitted to our team for approval.
        </Text>
        <Button className="dm-btn" style={button} href={confirmationUrl}>
          Confirm email address
        </Button>
        <Text style={small}>
          The link is valid for a limited time and can be used once. If the button does not work,
        ...
        <Section>
          ...
          <Text style={step}>
            2. Complete your organisation profile — legal name, industry, headquarters, currency,
            departments and hiring locations.
          </Text>
          <Text style={step}>
            3. Our platform team reviews the registration. You will receive a decision by email,
            with sign-in instructions once approved.
          </Text>
          <Text style={step}>
            4. After approval you can invite your recruiters and hiring managers on your own company
            domain and start raising requisitions.
          </Text>
        </Section>
        <Text style={footer}>
          If you did not start this registration, you can safely ignore this message — no account is
          created without confirmation, and nobody gains access to your organisation's data.
        </Text>
      </Container>
    </Body>
  </Html>
