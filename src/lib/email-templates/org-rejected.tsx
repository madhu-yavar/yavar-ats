...
const Email = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>
      Update on your {siteName} registration for {orgName}
    </Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Thank you for registering <strong>{orgName}</strong> on {siteName}. After review, our
          platform team was not able to approve the registration at this time.
        </Text>
        {reason ? (
        ...
        <Section>
          ...
          <Text style={step}>
            <strong>1.</strong> Reply to this email with the clarification or corrected details
            requested above — company legal name, headquarters and a work email on your company
            domain are the usual gaps.
          </Text>
          <Text style={step}>
            <strong>2.</strong> Once we can confirm the details, we re-open the registration and no
            data needs to be entered again.
          </Text>
          <Text style={step}>
            <strong>3.</strong> If the registration was created by mistake, no action is needed —
            nothing was activated and no team members were given access.
          </Text>
        </Section>
        <Text style={footer}>
