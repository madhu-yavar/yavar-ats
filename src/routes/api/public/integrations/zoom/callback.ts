/**
 * zoom returns the connected HR admin here after consent. Public by necessity
...
export const Route = createFileRoute("/api/public/integrations/zoom/callback")({
  server: {
    handlers: {
      GET: async ({ request }) => finishProviderConnect(request, "zoom"),
    },
  },
});
